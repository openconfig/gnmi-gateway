...
func ParseArgs(config *configuration.GatewayConfig) error {
	...
	flag.BoolVar(&config.Exporters.EnableGenevaFormat, "StatsdGenevaFormat", false, "Set to true for exporting statsd metrics in geneva format")
	flag.StringVar(&config.Exporters.GenevaAccount, "ExportersGenevaAccount", "", "Geneva account name")
	flag.StringVar(&config.Exporters.GenevaNamespace, "ExportersGenevaNamespace", "", "Geneva metric namespace")
	flag.StringVar(&config.Exporters.GenevaMetric, "ExportersGenevaMetric", "", "Geneva metric name")
	flag.Parse()

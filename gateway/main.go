...
func ParseArgs(config *configuration.GatewayConfig) error {
	...
	flag.StringVar(&config.Exporters.AzureMetricEndpoint, "AzureMetricEndpoint", "", "The endpoint to which azure exporter should write")
	flag.StringVar(&config.Exporters.AzureTokenEndpoint, "AzureTokenEndpoint", "", "The endpoint from which azure exporter will try to get auth token")
	flag.StringVar(&config.Exporters.AzureClientID, "AzureClientID", "", "The client_id for azure monitor token request")
	flag.StringVar(&config.Exporters.AzureClientSecret, "AzureClientSecret", "", "The client_secret for azure monitor token request")
	flag.Parse()

...
func ParseArgs(config *configuration.GatewayConfig) error {
	...
	flag.BoolVar(&config.TargetLoaders.Insecure, "TargetLoaderInsecure", false, "Insecurely connect to target loaders")
	flag.BoolVar(&config.TargetLoaders.NoTLSVerify, "TargetLoaderNoTLSVerify", false, "Skip TLS verification to target loaders")
	...
	flag.StringVar(&config.TargetLoaders.NetBoxBasePath, "TargetNetBoxBasePath", "", "NetBox API base path")

...
// Portions of this file (excluding modifications) are from
// https://github.com/openconfig/gnmi/blob/d2b4e6a45802a75b3571a627519cae85a197fdda/subscribe/subscribe_test.go
...
func (m MockCluster) MemberID() clustering.MemberID {
	panic("implement me")
}

func (m MockCluster) MemberList() ([]clustering.MemberID, error) {
	return []clustering.MemberID{}, nil
}

func (m MockCluster) MemberListCallback(callback clustering.MemberListCallbackFunc) error {
	panic("implement me")
}

func (m MockCluster) Register() error {
	panic("implement me")
}

func (m MockCluster) Unregister() error {
	panic("implement me")
}
...
func (m MockConnectionManager) Cache() *cache.Cache {
	panic("implement me")
}
...
func (m MockConnectionManager) TargetControlChan() chan<- *connections.TargetConnectionControl {
	panic("implement me")
}
